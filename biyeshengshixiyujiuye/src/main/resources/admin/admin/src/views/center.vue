  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业地址' prop="qiyeAddress">
               <el-input v-model="ruleForm.qiyeAddress"  placeholder='企业地址' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='qiye'" label='企业图片' prop="qiyePhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业联系方式' prop="qiyePhone">
               <el-input v-model="ruleForm.qiyePhone"  placeholder='企业联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业邮箱' prop="qiyeEmail">
               <el-input v-model="ruleForm.qiyeEmail"  placeholder='企业邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='qiye'"  label='所在行业' prop="qiyeTypes">
                 <el-select v-model="ruleForm.qiyeTypes"  placeholder='请选择所在行业'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='qiye'"  label="企业详情" prop="qiyeContent">
                 <editor
...
// 注册表 企业 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.qiyeAddress)&& 'qiye'==this.flag){
