...
public class ShixiView extends ShixiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 实习结果的值
		*/
		private String shixiJieguoValue;
	...
	public ShixiView(ShixiEntity shixiEntity) {
		try {
			...
			* 获取： 实习结果的值
			*/
			public String getShixiJieguoValue() {
				return shixiJieguoValue;
			}
			/**
			* 设置： 实习结果的值
			*/
			public void setShixiJieguoValue(String shixiJieguoValue) {
				this.shixiJieguoValue = shixiJieguoValue;
			}
